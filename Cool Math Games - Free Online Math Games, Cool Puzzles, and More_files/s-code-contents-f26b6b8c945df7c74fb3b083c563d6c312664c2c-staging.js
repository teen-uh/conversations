...
if ((domain.indexOf("dev.coolmath-games.com") > -1) || (domain.indexOf("stage.coolmath-games.com") > -1))s_account="coolmathgames-development";
else if ((domain.indexOf("mdev.coolmath-games.com") > -1) || (domain.indexOf("mtest.coolmath-games.com") > -1))s_account="coolmathgames-mobile-development";
else if ((domain.indexOf("m.coolmath-games.com") > -1) || (domain.indexOf("m.coolmath-games.com") > -1))s_account="coolmathgames-mobile-production";
else if (domain.indexOf("coolmath-games.com")>-1)s_account="coolmathgames-production";
else if ((domain.indexOf("dev.coolmath.com") > -1) || (domain.indexOf("stage.coolmath.com") > -1))s_account="coolmath-development";
else if (domain.indexOf("coolmath.com") > -1)s_account="coolmath-production";
...
s.linkInternalFilters="javascript:,www.coolmath.com"
...
if (domain.indexOf("m.coolmath.com") > -1)s.siteID="Mobile CoolMath";
else if (domain.indexOf("coolmath.com") > -1)s.siteID="CoolMath";
else if (domain.indexOf("coolmath-games.com") > -1)s.siteID="CoolMath Games";
else s.siteID = "Domain Not recognized";
s.queryVarsList="cid,id";
...
//Get new repeat status
s.eVar1=s.getNewRepeat(365);

//Percentage Page Viewed

s.prop3=s.getPreviousValue(s.pageName,'gpv','');
if (s.prop3)
  s.prop4=s.getPercentPageViewed();

//Time Parting
s.eVar2=s.getTimeParting('d','-5') + ' - ' + s.getTimeParting('h','-5');

//Get Page Load TIme
s.eVar3=s.getLoadTime("header","event3","event4");
...
s.visitorNamespace = "coolmath"
/* s.trackingServer = "coolmath.d2.sc.omtrdc.net"; */
s.trackingServer = "metrics.coolmath.com";
